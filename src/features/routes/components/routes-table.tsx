...
import { DataTableToolbar } from './routes-table-toolbar'
...
export function RoutesTable({ columns, data }: DataTableProps) {
  ...
  // Эффект для обновления выделения при изменении данных
  useEffect(() => {
